...
export default function AwardsPage() {
  return <main>
    ...
    <section className="award-note"><div className="shell"><p>This page highlights selected recognitions. Have a correction or an award to add?</p><a className="button button-accent" href="mailto:danahe.marmolejo@slu.edu?subject=RES2%20award%20update">Send an update <Arrow /></a></div></section>
  </main>;
}
