...
export default function ConsultancyPage() {
  return <main>
    ...
    <section className="consultancy section"><div className="shell consultancy-grid"><div><p className="eyebrow">A practical engagement</p><h2>Diagnose. Model. Translate.</h2><p className="consultancy-promise">The scope is shaped around the decision—not a predetermined deliverable.</p></div><div className="consultancy-copy"><div className="engagement-grid"><div><strong>Diagnose</strong><p>Clarify losses, bottlenecks, stakeholders, and the highest-value questions.</p></div><div><strong>Model</strong><p>Build transparent simulations, screening analyses, and scenarios.</p></div><div><strong>Translate</strong><p>Turn results into decisions, tools, recommendations, and training.</p></div></div><a className="button button-accent" href="mailto:danahe.marmolejo@slu.edu?subject=Consultancy%20inquiry">Discuss a project <Arrow /></a></div></div></section>
  </main>;
}
